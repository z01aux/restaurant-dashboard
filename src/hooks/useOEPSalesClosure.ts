...
import { OEPCashRegisterStatus, OEPSalesClosure } from '../types/oep-sales';

export const useOEPSalesClosure = () => {
    const [loading, setLoading] = useState(false);
    const [cashRegister, setCashRegister] = useState<OEPCashRegisterStatus | null>(null);
    const [closures, setClosures] = useState<OEPSalesClosure[]>([]);
