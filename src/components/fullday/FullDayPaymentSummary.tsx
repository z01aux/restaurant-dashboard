// ============================================
// ARCHIVO: src/components/fullday/FullDayPaymentSummary.tsx
// Resumen de pagos para FullDay
// ============================================

import React from 'react';

interface FullDayPaymentSummaryProps {
  paymentSummary: {
...
export const FullDayPaymentSummary = React.memo(({
  paymentSummary,
  todayTotal,
  paymentFilter,
  setPaymentFilter
}: FullDayPaymentSummaryProps) => {
  return (
