...
export const OEPPaymentModal: React.FC<OEPPaymentModalProps> = ({
    ...
    const paymentMethods: { value: 'EFECTIVO' | 'YAPE/PLIN' | 'TARJETA'; label: string; icon: any; color: string; }[] = [
                        ...
                        {paymentMethods.map(method => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`w-full p-4 rounded-xl border-2 text-left font-semibold transition-all flex items-center space-x-3 ${isSelected
