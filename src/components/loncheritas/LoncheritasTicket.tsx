...
const LoncheritasTicket: React.FC<LoncheritasTicketProps> = ({ order }) => {
      ...
      <Page size={[PAGE_WIDTH]} style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            <Text>{order.grade} - Sección {order.section}</Text>
          </View>
          <View style={styles.row}>
    ...
    return `
      <div class="ticket">
        ...
        <div class="info-row">
          ...
          <span class="value">LONCHERITAS</span>
        </div>
        <div class="info-row">
        ...
        <div class="info-row">
          ...
          <span class="value">${order.grade} - Sección ${order.section}</span>
        </div>
        <div class="info-row">
