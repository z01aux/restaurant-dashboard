// ============================================
// ARCHIVO: src/components/loncheritas/LoncheritasDateFilter.tsx
// Selector de fecha con flechas para Loncheritas (igual que FullDay y OEP)
// ============================================

import React from 'react';
import { Calendar, ChevronLeft, ChevronRight } from 'lucide-react';

interface LoncheritasDateFilterProps {
  selectedDate: Date;
  onDateChange: (date: Date) => void;
  totalOrders: number;
}

export const LoncheritasDateFilter: React.FC<LoncheritasDateFilterProps> = ({
  selectedDate,
  onDateChange,
  totalOrders
}) => {
