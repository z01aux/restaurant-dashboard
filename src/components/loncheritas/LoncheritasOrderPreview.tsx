...
export const LoncheritasOrderPreview: React.FC<LoncheritasOrderPreviewProps> = ({
  ...
  // ✅ ACTUALIZADO: Muestra detalle completo del pago mixto
  const getPaymentDisplay = (order: LoncheritasOrder): string => {
  ...
  // ✅ Color del badge según método
  const getPaymentBadgeColor = (order: LoncheritasOrder): string => {
    ...
    >
      ...
      <div className="flex items-center justify-between mb-3 pb-2 border-b border-gray-100">
        ...
        <div className="text-right">
          ...
          <div className="text-xs text-gray-500 mt-1">🍱 Loncheritas</div>
        </div>
      </div>
      ...
      <div className="border-t border-gray-100 pt-2">
        <div className="flex justify-between items-center mb-2">
          ...
          <span className="text-lg font-bold text-orange-600">S/ {order.total.toFixed(2)}</span>
        </div>
        {order.notes && (
