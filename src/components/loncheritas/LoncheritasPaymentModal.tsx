...
export const LoncheritasPaymentModal: React.FC<LoncheritasPaymentModalProps> = ({
  ...
  const handleSelectMethod = (value: 'EFECTIVO' | 'YAPE/PLIN' | 'TARJETA' | 'none') => {
    setSelectedMethod(value === 'none' ? null : value);
  };
        ...
        <div className="p-6">
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-bold text-orange-600">S/ {order.total.toFixed(2)}</span>
            </div>
          </div>
          ...
          <div className="flex space-x-3">
            ...
            <button
              ...
              className="flex-1 bg-gradient-to-r from-orange-500 to-yellow-500 text-white px-4 py-3 rounded-lg hover:shadow-md transition-all duration-300 disabled:opacity-50 flex items-center justify-center space-x-2 font-semibold"
            >
              {saving ? (
                <>
