          ...
          <head>
            ...
            <style>
              ...
              * {
              ...
              /* EVITAR SALTO DE PÁGINA EN MEDIO DEL CONTENIDO */
              .ticket {
          ...
          <body>
            ...
            <script>
              window.onload = function() {
                ...
                setTimeout(function() {
                  window.print();
                  // Cerrar después de imprimir (con más tiempo)
                  setTimeout(function() {
                    window.close();
                  }, 1500);
                }, 200);
              ...
              // Fallback: permitir cerrar manualmente si hay problemas
