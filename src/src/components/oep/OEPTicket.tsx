...
// Ticket OEP — mismo diseño que OrderTicket
// ============================================================
            ...
            <Page size={[PAGE_WIDTH]} style={styles.page}>
                ...
                <View style={styles.section}>
                    <View style={styles.row}>
                        ...
                        <Text style={styles.valueBold}>{order.customer_name.toUpperCase()}</Text>
                    </View>
                    {order.phone && (
                        <View style={styles.row}>
    ...
    const generateTicketHTML = (): string => `
        <div class="ticket">
            ...
            <div class="info-row">
                ...
                <span class="customer-name-bold">${order.customer_name.toUpperCase()}</span>
            </div>
            ${order.phone ? `
                <div class="info-row">
