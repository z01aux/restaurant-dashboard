...
/**
 * Obtiene el inicio del día en la zona horaria local (00:00:00)
 */
...
/**
 * Obtiene el fin del día en la zona horaria local (23:59:59.999)
 */
...
/**
 * Exporta órdenes por rango de fechas - CORREGIDO PROBLEMA DE ZONA HORARIA
 */
export const exportOrdersByDateRange = async (
  ...
  // Ajustar las fechas para que funcionen correctamente con la zona horaria local
